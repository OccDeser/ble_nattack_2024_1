...
Through comprehensive case studies using EntropyVerif, we not only rediscovered known attacks but also uncovered a novel attack on Bluetooth Classic devices, which termed the Unilateral Multi-Downgrade (UMD) attack. 
