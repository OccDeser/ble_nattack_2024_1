...
Current symbolic model analysis tools do not emphasize the strength of keys within protocols. 
This oversight results in a limitation where existing tools are unable to generally find attacks associated with low-entropy keys.
...
We developed EntropyVerif, an extension of the symbolic analysis tool \Tamarin{}, which allows users to specify the entropy of keys and automatically find brute-force attacks.
...
Through these studies, we not only rediscovered known attacks but also uncovered a novel attack on Bluetooth Classic devices, which we have termed the Unilateral Multi-Downgrade (UMD) attack. 
