...
We enhance the TAMARIN Prover by introducing new syntax to explicitly mark low-entropy keys and develop a compilation tool to translate these models for analysis. 
Our method identifies vulnerabilities in real-world protocols, rediscovering known attacks and uncovering a novel one, the unilateral multi-downgrade (UMD) attack in Bluetooth, which significantly reduces the difficulty of adversaries to compromise session keys.
\end{abstract}     
