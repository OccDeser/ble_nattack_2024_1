...
Our adversary extends the classical Dolev-Yao attacker~\cite{dolev1983security} with a bounded brute-force capability.
...
The cost of each such recovery is $2^{|k|}$ elementary operations, where $|k|$ is the nominal bit-length of $k$; an attacker is admitted to perform the recovery only if $|k|$ lies within an a priori computational budget.
