...
On February~7, 2025 the SIG replied with the results of its internal analysis. For our scenario it
wrote that ``the scenario posited for identifying the session key used during BR/EDR encryption
establishment appears much more practical'', a comparison with the other scenario in the same
letter rather than with previously published attacks, and noted that accepting short encryption
key lengths remains an implementation decision made for backward compatibility.
