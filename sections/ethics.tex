...
We reported the vulnerability to the Bluetooth Special Interest Group~(SIG) security team on July~15, 2024, 
under the heading of a unilateral key downgrade.
...
any device.
We have therefore not demonstrated the attack against a physical device.
