...
\begin{itemize}[leftmargin=*]
    ...
    \item \emph{Tool without kernel modification.} We developed EntropyVerif, a syntax-sugar extension of \Tamarin{}, in which users annotate low-entropy terms with \texttt{:= L}. The compiler emits standard multiset-rewriting rules so that verification soundness is inherited directly from the unmodified \Tamarin{} backend.
