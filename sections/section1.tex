...
We have designed a new syntax, which is a superset of the syntax of \Tamarin{}, allowing for labelling low-entropy variables in symbolic models. 
...
\begin{itemize}[leftmargin=*]
    ...
    \item  We applied our methodology to develop a protocol analysis tool that accepts models with low-entropy labels. This tool can automatically analyze vulnerabilities associated with low-entropy keys in protocols and generally capture brute-force attacks.
