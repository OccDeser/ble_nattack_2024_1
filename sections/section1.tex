...
Entropy is a fundamental concept which is directly correlated with the security of the cryptographic system.
...
\begin{enumerate}[leftmargin=*]
    ...
    However, in practice, an attacker may attempt to brute-force any key as long as its entropy does not exceed their computational capacity. 
    The attacker may also deconstruct complex keys into simpler sub-keys and brute-force them individually. 
    A key challenge lies in modeling this flexible brute-forcing capability within the symbolic model.
\end{enumerate}
...
We have designed a new syntax, which is a superset of the syntax of \Tamarin{}, allowing for the labelling of low-entropy variables in symbolic models. 
...
\begin{itemize}[leftmargin=*]
    ...
    Our tool allow us to analyze vulnerabilities associated with low-entropy keys in protocols and generally capture brute-force attacks.
