...
\begin{enumerate}[leftmargin=*]
    ...
    However, in practice, an attacker may attempt to brute-force any key as long as its entropy does not exceed its computational capacity. 
...
\begin{itemize}[leftmargin=*]
    ...
    Our tool allows us to analyze vulnerabilities associated with low-entropy keys in protocols and generally capture brute-force attacks.
