...
The method of trying all possible keys until the correct one is found is called a brute-force attack.
Brute-force attacks can be categorized into online and offline attacks.
...
In an offline attack, the attacker only needs to obtain the ciphertext and attempt all possible keys to decrypt it.
Since online attacks require continuous interaction with the target system, they are less efficient than offline attacks.
In this paper, we focus on offline brute-force attacks; all subsequent references to brute-force attacks pertain to the offline variant unless stated otherwise.
