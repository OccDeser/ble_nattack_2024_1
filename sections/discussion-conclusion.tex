...
protocol; if the modeler overstates what the attacker can do and picks a budget looser than that
attacker, the analysis can report attacks that are valid in the symbolic model but infeasible in
practice.
