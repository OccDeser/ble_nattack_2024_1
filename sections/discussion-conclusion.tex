...
In practice, the BC and BLE models rely on hand-written \Tamarin{} tactics that reorder goals so
that infeasible branches close earlier, and use no auxiliary lemmas. Section~\ref{sec:6results}
...
When a real protocol uses a private function, one can often replace it with a combination of public functions and private variables, and the resulting model stays within the attacker model of Section~\ref{sec:threat-model}; we leave native support for private functions to future work.
