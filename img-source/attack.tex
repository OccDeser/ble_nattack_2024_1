...
\node[AGENT, right=0.3\textwidth of n_initiator, text=GaoliangRed] (n_attacker) {Attacker};
\node[AGENT, right=0.3\textwidth of n_attacker] (n_responder) {Responder};
...
\draw[ARROW] (c_init_req) -- (c_atta_req) node[midway,above=-0.3ex]{Pairing Request \{$KeySize: 16$\}};
\draw[ARROW] (c_atta_req) -- (c_resp_req) node[midway,above=-0.3ex]{Pairing Response \{\textcolor{GaoliangRed}{$KeySize: 8$}\}};
...
\draw[ARROW] (c_resp_rsp) -- (c_atta_rsp) node[midway,above=-0.3ex]{Pairing Response\{$KeySize: 16$\}};
\draw[ARROW] (c_atta_rsp) -- (c_init_rsp) node[midway,above=-0.3ex]{Pairing Response\{$KeySize: 16$\}};
...
\coordinate (c_atta_encreq) at ($(c_init_encreq-|c_atta_checkr)$);
\coordinate (c_resp_encreq) at ($(c_init_encreq-|c_resp_checkr)$);
\draw[ARROW] (c_init_encreq) -- (c_atta_encreq) node[midway,above=-0.3ex]{LL\_ENC\_REQ \{$SKD_I$\}};
\draw[ARROW] (c_atta_encreq) -- (c_resp_encreq) node[midway,above=-0.3ex]{LL\_ENC\_REQ \{$SKD_I$\}};

\coordinate (c_init_encrsp) at ($(c_init_encreq)+(0,-4ex)$);
\coordinate (c_atta_encrsp) at ($(c_init_encrsp-|c_atta_checkr)$);
\coordinate (c_resp_encrsp) at ($(c_init_encrsp-|c_resp_checkr)$);
\draw[ARROW] (c_resp_encrsp) -- (c_atta_encrsp) node[midway,above=-0.3ex]{LL\_ENC\_RSP \{$SKD_R$\}};
\draw[ARROW] (c_atta_encrsp) -- (c_init_encrsp) node[midway,above=-0.3ex]{LL\_ENC\_RSP \{$SKD_R$\}};

\coordinate (c_init_startencreq) at ($(c_init_encrsp)+(0,-4ex)$);
\coordinate (c_atta_startencrsp) at ($(c_init_startencreq-|c_atta_encrsp)$);
\draw[ARROW] (c_init_startencreq) -- (c_atta_startencrsp) node[midway,above=-0.3ex]{\textcolor{JidanYellow}{LL\_START\_ENC\_RSP}};


\coordinate (c_resp_term) at ($(c_init_startencreq-|c_resp_encrsp)$);
\draw[ARROW] (c_atta_startencrsp) -- (c_resp_term) node[midway,above=-0.3ex]{LL Terminate};


\coordinate (c_atta_adv) at ($(c_atta_startencrsp)+(0,-4ex)$);
\coordinate (c_resp_adv) at ($(c_atta_adv-|c_resp_term)$);
\draw[ARROW] (c_atta_adv) -- (c_resp_adv) node[midway,above=-0.3ex]{Advertising};

\coordinate (c_atta_encreq2) at ($(c_atta_adv)+(0,-4ex)$);
\coordinate (c_resp_encreq2) at ($(c_atta_encreq2-|c_resp_adv)$);
\draw[ARROW] (c_resp_encreq2) -- (c_atta_encreq2) node[midway,above=-0.3ex]{LL\_ENC\_REQ \{$SKD_I$\}};

\coordinate (c_atta_encrsp2) at ($(c_atta_encreq2)+(0,-4ex)$);
\coordinate (c_resp_encrsp2) at ($(c_atta_encrsp2-|c_resp_encreq2)$);
\draw[ARROW] (c_atta_encrsp2) -- (c_resp_encrsp2) node[midway,above=-0.3ex]{LL\_ENC\_RSP \{$SKD_R$\}};

\coordinate (c_atta_startencrsp2) at ($(c_atta_encrsp2)+(0,-4ex)$);
\coordinate (c_resp_startencreq2) at ($(c_atta_startencrsp2-|c_resp_encrsp2)$);
\draw[ARROW] (c_resp_startencreq2) -- (c_atta_startencrsp2) node[midway,above=-0.3ex]{\textcolor{JidanYellow}{LL\_START\_ENC\_RSP}};

\coordinate (c_atta_bf) at ($(c_atta_startencrsp2)+(0,-4ex)$);
...
\coordinate (c_resp_startencreq3) at ($(c_atta_startencrsp3-|c_resp_startencreq2)$);
